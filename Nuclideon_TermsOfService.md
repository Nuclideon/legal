...
- Internal benchmarking of the Services for your own operational purposes is permitted without restriction and does not require Nuclideon's consent.
- Public benchmarking — meaning the publication or distribution of comparative performance analysis of the Services against competing products — requires Nuclideon's prior written consent. Nuclideon will not unreasonably withhold or delay such consent and will respond to requests within ten (10) business days. Where consent is granted, Nuclideon may reasonably request that methodology be disclosed alongside published results or that results be anonymised to the extent necessary to protect non-public technical information.
...
## 8. Free Tiers and Trial Subscriptions
...
11.1. Nuclideon's collection, use, and disclosure of personal information is governed by the [Nuclideon Privacy Policy](https://nuclideon.com/privacy-policy), which is incorporated into these Terms by reference. By using the Services, you acknowledge and agree to the practices described in the Privacy Policy.
...
11.5. **Google API Services Limited Use Disclosure.** Nuclideon's use and transfer to any other app of information received from Google APIs will adhere to the [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including the Limited Use requirements. Nuclideon does not use Google user data for serving advertisements, does not allow humans to read Google user data unless necessary to provide the Services and customer support, required for security purposes, or required by applicable law, and does not transfer Google user data to third parties except as necessary to provide the Services, as required by law, or with your explicit consent.
...
19.3. The current version of these Terms is always available at [https://nuclideon.com/terms-of-service](https://nuclideon.com/terms-of-service). This is the authoritative version of the Terms. A revision history is maintained at [https://github.com/Nuclideon/legal](https://github.com/Nuclideon/legal) for transparency, but in the event of any discrepancy, the version published at nuclideon.com prevails.
...
- (i) the sub-processor is located in a jurisdiction that has not been recognised as providing an adequate level of data protection under applicable Data Protection Laws, and no appropriate transfer mechanism is in place;
- (ii) the sub-processor has experienced a material data breach or has a documented history of data protection failures within the preceding three (3) years;
- (iii) engagement of the sub-processor would conflict with the Customer's own regulatory or industry compliance requirements (for example, obligations under HIPAA, ITAR, or sector-specific government security frameworks); or
- (iv) the sub-processor's processing activities are materially inconsistent with the description provided in Nuclideon's notice.
...
### A.9 International Data Transfers
